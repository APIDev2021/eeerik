...
function bootOS(){
  ...
  function loadJSON(callback) {
     ...
     xobj.open('GET', 'apps/VirtualVandal/models/erik.json', true); // Replace 'my_data' with the path to your file
...
function displayUnsupportedMessage(){
  ...
  //Make links
  var tempLinks = '<a href="http://behance.net/erikbernacchi">behance.net/erikbernacchi</a><br>'+
                  '<a href="http://dribbble.com/erikbernacchi">dribbble.com/erikbernacchi</a><br>'+
                  '<a href="mailto:erik.bernacchi@gmail.com?subject=Hey Erik&body=Listen...">erik.bernacchi@gmail.com</a>';
