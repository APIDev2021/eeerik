...
if (typeof installedApps !== 'undefined') {
  ...
  installedApps[memeExe.uniqueAppID].OsMenu = {
    ...
    'File': [['Open Image','openImage'],['Export Masterpiece','exportImage'],'-',['Share on fb','shareFB'], ['share on twitter','shareTwitter']],
...
memeExe.downloadImage = function() {
  memeExe.renderMeme();
  var fileName = memeExe.topText + " - Made With eeerik dot com";
